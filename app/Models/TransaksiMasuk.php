...
class TransaksiMasuk extends Model
{
  ...
  public function getAllTransactions()
  {
    ...
    return $model
      ->select([
        'transaksi_masuk.id',
        'transaksi_masuk.nama',
        'layanan.nama_layanan',
        'transaksi_masuk.tgl_masuk',
        'transaksi_masuk.tgl_selesai',
        'transaksi_masuk.total_harga',
        'transaksi_masuk.jumlah_item',
        'transaksi_masuk.lunas',
        'transaksi_masuk.status',
        'transaksi_masuk.user_creator',
        'transaksi_masuk.user_editor',
        'transaksi_masuk.created_at',
        'transaksi_masuk.updated_at'
      ])
