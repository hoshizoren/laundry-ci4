...
class ReportController extends BaseController
{
    ...
    public function indexTransaksiMasuk()
    {
        ...
        if ($this->request->getVar('dari_tanggal')) {
            ...
            $transaksi_laundry = $this->TransaksiMasuk->countTransactionReport(["tgl_masuk BETWEEN '$dari_tanggal' AND '$sampai_tanggal'", "layanan.nama_layanan LIKE '%laundry%'"]);
            $transaksi_setrika = $this->TransaksiMasuk->countTransactionReport(["tgl_masuk BETWEEN '$dari_tanggal' AND '$sampai_tanggal'", "layanan.nama_layanan LIKE '%setrika%'"]);
        } else {
            ...
            $transaksi_laundry = $this->TransaksiMasuk->countTransactionReport("layanan.nama_layanan LIKE '%laundry%'");
            $transaksi_setrika = $this->TransaksiMasuk->countTransactionReport("layanan.nama_layanan LIKE '%setrika%'");
        }
        $data = [
            'title' => 'Reports',
            'header' => $header,
