...
class PDFController extends BaseController
{
  ...
  protected $TransaksiPengambilan;
  protected $Layanan;
  protected $Item;
  protected $Pemasukan;
  ...
  public function invoicePDF($transaksiID)
  {
    $data = [
      ...
      'data' => $this->TransaksiMasuk
        ->select('transaksi_masuk.*, layanan.nama_layanan')
  ...
  public function transaksiMasukPDF($dateStart, $dateEnd)
  {
    $data = [
      ...
      'transaksi_laundry' => $this->TransaksiMasuk->countTransactionReport(["tgl_masuk BETWEEN '$dateStart' AND '$dateEnd'", "layanan.nama_layanan LIKE '%laundry%'"]),
      'transaksi_setrika' => $this->TransaksiMasuk->countTransactionReport(["tgl_masuk BETWEEN '$dateStart' AND '$dateEnd'", "layanan.nama_layanan LIKE '%setrika%'"]),
    ];
